...
public:
    ...
    struct boss_lich_king_horAI : public npc_escortAI
    {
        ...
        void Reset()
        {
            ...
            walkSpeed = 1.0f;
            uiWall = 0;
            if (pInstance->GetData(DATA_LICHKING_EVENT) == DONE)
                me->SetVisible(false);
        }
        ...
        void WaypointReached(uint32 i)
        {
            ...
            switch(i)
            {
            	...
            	case 26:
                    ...
                    if(Unit* sylvanas = me->FindNearestCreature(NPC_SYLVANAS_PART2, 100.0f, true))
                        me->CastSpell(sylvanas, SPELL_HARVEST_SOUL, false);
                    if (Unit* jaina = me->FindNearestCreature(NPC_JAINA_PART2, 100.0f, true))
                    	me->CastSpell(jaina, SPELL_HARVEST_SOUL, false);
                    me->setActive(false);
                    break;
            }
        }
